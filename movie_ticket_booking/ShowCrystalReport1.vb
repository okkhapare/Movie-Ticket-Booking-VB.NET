...
Public Class ShowCrystalReport1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "movie_ticket_booking.ShowCrystalReport1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedShowCrystalReport1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ShowCrystalReport1 = New ShowCrystalReport1
        rpt.Site = Me.Site
        Return rpt
    End Function
